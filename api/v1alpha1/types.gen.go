...
const (
	ResourceTypeCertificateSigningRequest ResourceType = "CertificateSigningRequest"
	...
	ResourceTypeTemplateVersion           ResourceType = "TemplateVersion"
)
...
type Event struct {
	...
	// ResourceType Resource types exposed via the API.

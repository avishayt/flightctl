...
func (h *ServiceHandler) CreateEnrollmentRequest(ctx context.Context, er api.EnrollmentRequest) (*api.EnrollmentRequest, api.Status) {
	...
	h.CreateEvent(ctx, GetResourceCreatedEvent(ctx, api.EnrollmentRequestKind, *er.Metadata.Name, status))
...
func (h *ServiceHandler) ReplaceEnrollmentRequest(ctx context.Context, name string, er api.EnrollmentRequest) (*api.EnrollmentRequest, api.Status) {
	...
	if created {
		h.CreateEvent(ctx, GetResourceCreatedEvent(ctx, api.EnrollmentRequestKind, name, status))
	} else {
		h.CreateEvent(ctx, GetResourceUpdatedEvent(ctx, api.EnrollmentRequestKind, name, status, &updateDesc))
	}
	return result, status
}

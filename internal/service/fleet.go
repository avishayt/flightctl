...
func (h *ServiceHandler) CreateFleet(ctx context.Context, fleet api.Fleet) (*api.Fleet, api.Status) {
	...
	EmitResourceUpdatedEvent(ctx, h.store.Event(), h.log, orgId, status, *fleet.Metadata.Name, api.ResourceTypeFleet, nil)
...
func (h *ServiceHandler) ReplaceFleet(ctx context.Context, name string, fleet api.Fleet) (*api.Fleet, api.Status) {
	...
	EmitResourceUpdatedEvent(ctx, h.store.Event(), h.log, orgId, status, *fleet.Metadata.Name, api.ResourceTypeFleet, &details)
	return result, status
}
...
func (h *ServiceHandler) DeleteFleet(ctx context.Context, name string) api.Status {
	...
	EmitResourceDeletedEvent(ctx, h.store.Event(), h.log, orgId, status, name, api.ResourceTypeFleet)
	return status
}

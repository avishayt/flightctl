...
func (h *TransportHandler) ReadTemplateVersion(w http.ResponseWriter, r *http.Request, fleet string, name string) {
	body, status := h.serviceHandler.ReadTemplateVersion(r.Context(), fleet, name)
	SetResponse(w, body, status)
}

...
func (m *MockWorkerClient) EmitEvent(ctx context.Context, event *v1alpha1.Event) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "EmitEvent", ctx, event)
}

// EmitEvent indicates an expected call of EmitEvent.
func (mr *MockWorkerClientMockRecorder) EmitEvent(ctx, event any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EmitEvent", reflect.TypeOf((*MockWorkerClient)(nil).EmitEvent), ctx, event)
}
